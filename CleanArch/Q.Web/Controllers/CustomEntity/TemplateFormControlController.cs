...
namespace Q.Web.Controllers.CustomEntity
{
    ...
    [ApiController]
    public class TemplateFormControlController : ControllerBase
    {
        private readonly ITemplateFormControlService _templateFormControlService;

        public TemplateFormControlController(ITemplateFormControlService templateFormControlService)
        {
            _templateFormControlService = templateFormControlService;
        }
        ...
        {
            var data = await _templateFormControlService.GetAll();
            return Ok(data);
        }
        ...
        {
            var customFields = await _templateFormControlService.GetFieldsByTabId(tabId);
        ...
        public async Task<IActionResult> Post([FromBody] CustomFieldRequestModel createCustomFieldRequest)
        {
            ...
            var response = await _templateFormControlService.Add(customField);
            return Ok(response);
        }
        ...
        public async Task<IActionResult> Put(int id, [FromBody] CustomFieldRequestModel createCustomFieldRequest)
        {
            ...
            return Ok(await _templateFormControlService.UpdateAsync(customFieldDto));
        }
        ...
        {
            return Ok(await _templateFormControlService.DeleteAsync(id));
        }
    }
}
