...
namespace Q.Infrastructure.Migrations
{
    ...
    [Migration("20180730132419_AddedRecurrenceData")]
    partial class AddedRecurrenceData
    {
            ...
            modelBuilder.Entity("Q.Domain.Common.RecurrenceType", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, AddedBy = 1, AddedDate = new DateTime(2018, 7, 30, 14, 24, 18, 461, DateTimeKind.Local), DatePart = "yy", IsActive = true, IsArchived = false, IsDeleted = false, Name = "Annually", RecurrenceNumber = (short)1 },
                        new { Id = 2, AddedBy = 1, AddedDate = new DateTime(2018, 7, 30, 14, 24, 18, 462, DateTimeKind.Local), DatePart = "MM", IsActive = true, IsArchived = false, IsDeleted = false, Name = "Monthly", RecurrenceNumber = (short)1 },
                        new { Id = 3, AddedBy = 1, AddedDate = new DateTime(2018, 7, 30, 14, 24, 18, 462, DateTimeKind.Local), DatePart = "dd", IsActive = true, IsArchived = false, IsDeleted = false, Name = "Daily", RecurrenceNumber = (short)1 }
                    );
                });
