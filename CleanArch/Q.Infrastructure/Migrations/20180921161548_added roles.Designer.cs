...
namespace Q.Infrastructure.Migrations
{
    ...
    [Migration("20180921161548_added roles")]
            ...
            modelBuilder.Entity("Q.Domain.Common.RecurrenceType", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, AddedBy = 1, AddedDate = new DateTime(2018, 9, 21, 17, 15, 47, 966, DateTimeKind.Local), DatePart = "yy", IsActive = true, IsArchived = false, IsDeleted = false, Name = "Annually", RecurrenceNumber = (short)1 },
                        new { Id = 2, AddedBy = 1, AddedDate = new DateTime(2018, 9, 21, 17, 15, 47, 966, DateTimeKind.Local), DatePart = "MM", IsActive = true, IsArchived = false, IsDeleted = false, Name = "Monthly", RecurrenceNumber = (short)1 },
                        new { Id = 3, AddedBy = 1, AddedDate = new DateTime(2018, 9, 21, 17, 15, 47, 966, DateTimeKind.Local), DatePart = "dd", IsActive = true, IsArchived = false, IsDeleted = false, Name = "Daily", RecurrenceNumber = (short)1 }
                    );
                });
            ...
            modelBuilder.Entity("Q.Domain.User.UserRole", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, AddedBy = 1, AddedDate = new DateTime(2018, 9, 21, 16, 15, 47, 966, DateTimeKind.Utc), IsArchived = false, IsDeleted = false, RoleName = "Admin" },
                        new { Id = 2, AddedBy = 1, AddedDate = new DateTime(2018, 9, 21, 16, 15, 47, 966, DateTimeKind.Utc), IsArchived = false, IsDeleted = false, RoleName = "user" }
                    );
                });
            ...
            modelBuilder.Entity("Q.Domain.User.UserType", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, AddedBy = 1, AddedDate = new DateTime(2018, 9, 21, 16, 15, 47, 966, DateTimeKind.Utc), IsArchived = false, IsDeleted = false, Name = "Visitor" },
                        new { Id = 2, AddedBy = 1, AddedDate = new DateTime(2018, 9, 21, 16, 15, 47, 966, DateTimeKind.Utc), IsArchived = false, IsDeleted = false, Name = "Reporter" }
                    );
                });
